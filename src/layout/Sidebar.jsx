...
const Sidebar = () => {
  return (
    ...
    <div className="w-65 h-screen shrink-0 bg-gray-800 p-5 text-2xl text-white overflow-y-hidden">
      ...
      <h3 className="m-2 hover:bg-gray-600 w-50 h-12 p-2 hover:rounded-xl">Register</h3>
      <h3 className="m-2 hover:bg-gray-600 w-50 h-12 p-2 hover:rounded-xl">Profile</h3>
      <h3 className="m-2 hover:bg-gray-600 w-50 h-12 p-2 hover:rounded-xl">Tasks</h3>
